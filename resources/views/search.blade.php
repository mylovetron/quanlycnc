    	...
    	$(document).ready(function() {
			...
			$('#search').typeahead({
				...
				display: function(data) {
					return data.tenvattu  //Input value to be set when you select a suggestion. 
				},
				templates: {
					empty: [
					...
					return '<div style="font-weight:normal; margin-top:-10px ! important;" class="list-group-item">' + data.tenvattu + '</div></div>'
					}
				}
			});
        });
