...
@section('content')
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" action="{!! route('admin.phieuxuat.getAdd') !!}" method="POST">
				<input type="hidden" name="_token" value="{!! csrf_token() !!}" />
				
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Ngày xuất</label>
					<div class="col-sm-9">
						<input type="date" id="dateNgayXuat"  name="dateNgayXuat" placeholder="ngày nhập" class="col-xs-10 col-sm-5" value="<?php echo date("Y-m-d"); ?>" />
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Người xuất</label>
					<div class="col-sm-9">
						<input type="text" id="txtNguoiXuat"  name="txtNguoiXuat" placeholder="Người nhập" class="col-xs-10 col-sm-5" />
					</div>
				</div>
